<template>
    <v-app class="app_works">
        <div class="works_items" >
            ...
            <nuxt-link  :to="'/works/'+work.id" class="works_items_box" v-for="work in works" :key="work.id">
                <img :src="'/img/works/' + work.thumbnail"  @load="imageLoad(index)" class="works_thumbnail">
